...
export async function runPipeline(sourceContext, sourceMeta = {}, adjMeta = {}, isEscalation = false) {
  ...
  async function _runExtractors(extractModel) {
    const eA = genAI.getGenerativeModel({ model: extractModel, systemInstruction: EXTRACTOR_PROMPT_A + escalationWarning });
    const eB = genAI.getGenerativeModel({ model: extractModel, systemInstruction: EXTRACTOR_PROMPT_B + escalationWarning });
