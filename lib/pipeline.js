...
// Using gemini-2.0-flash (no thinking overhead) until we migrate to @google/genai SDK.
// gemini-2.5-flash with thinking enabled adds 10-30s per call and breaks the 60s limit.
const GEMINI_MODEL         = 'gemini-2.0-flash';
const GEMINI_MODEL_LITE    = 'gemini-1.5-flash';       // fallback when primary is overloaded
