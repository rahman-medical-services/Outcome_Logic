...
4. PRIMARY ENDPOINT — extract all of the following:
   ...
   Format immediately after the main effect size extraction:
     candidate_values:
       1. value=X.XX | label="[e.g. adjusted HR, Cox model, Table 2]" | population=[ITT/PP/mITT] | arm_a=[GROUP_NAME: X.XX UNITS] | arm_b=[GROUP_NAME: X.XX UNITS] | [SRC: ...]
       2. value=X.XX | label="[e.g. unadjusted HR, abstract Results]" | population=[ITT/PP/mITT] | arm_a=[GROUP_NAME: X.XX UNITS] | arm_b=[GROUP_NAME: X.XX UNITS] | [SRC: ...]
   ...
   The between-group difference (HR, OR, MD, risk difference) belongs in the "value" field — NEVER in arm_a or arm_b.
  ...
  "primary_endpoint_candidates": [
    {
      ...
      "arm_b_sd": null,
      "value_type": "rate_pct | mean_score | median | count — what arm_a_value and arm_b_value represent",
      "value_unit": "String or null — e.g. '% events', 'SF-36 points', 'mmHg', 'seconds'",
      "ci_lower": 0.0,
      "ci_upper": 0.0,
