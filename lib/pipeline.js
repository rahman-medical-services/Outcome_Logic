...
4. PRIMARY ENDPOINT — extract all of the following:
   ...
   Format immediately after the main effect size extraction:
     candidate_values:
       1. value=X.XX | effect_measure=[HR/OR/RR/MD/RD/difference] | p=[p-value or 'not reported'] | label="[e.g. adjusted HR, Cox model, Table 2]" | population=[ITT/PP/mITT] | arm_a=[GROUP_NAME: X.XX UNITS] | arm_b=[GROUP_NAME: X.XX UNITS] | [SRC: ...]
       2. value=X.XX | effect_measure=[HR/OR/RR/MD/RD/difference] | p=[p-value or 'not reported'] | label="[e.g. unadjusted HR, abstract Results]" | population=[ITT/PP/mITT] | arm_a=[GROUP_NAME: X.XX UNITS] | arm_b=[GROUP_NAME: X.XX UNITS] | [SRC: ...]
