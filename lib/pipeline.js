...
// Retries up to 5 times on 503 with exponential backoff + jitter.
// thinkingBudget: 128 caps thinking tokens to reduce TPM consumption.
async function callGemini(model, { systemInstruction, contents, temperature = 0, responseMimeType } = {}) {
  ...
  body.generationConfig = { temperature, thinkingConfig: { thinkingBudget: 128 } };
