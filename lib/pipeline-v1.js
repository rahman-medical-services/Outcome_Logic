...
4. PRIMARY ENDPOINT — extract all of the following:
   ...
   e.g. "496 were assigned to TAVI"; (3) Results section opening sentence, e.g. "XXX patients were
   randomised to intervention". Do NOT leave arm_a_n / arm_b_n null if N per arm appears anywhere.
...
8. ADVERSE EVENTS — Grade ≥3 or ≥2% either arm:
   ...
   (b) Remove from your AE candidate list ANY event matching (a) — regardless of whether it
       appears in the paper's safety table. Primary endpoint components belong in outcomes, never in AE.
   NOTE: Secondary endpoints may remain in the AE table if they appear there — they represent both
   efficacy and safety data and are clinically appropriate in both sections. Do NOT exclude events
   solely because they are named secondary endpoints.
