...
Step 3: Remove only rows matching primary endpoint components. If all rows are removed, set has_data to false.
...
2. Does the PICO (population, intervention, control) description match the paper?
3. Is the trial design classification (study_design field) correct?
