...
export const MA_FIELDS = [
  ...
  { id: 'rob_overall',             label: 'Risk of Bias — overall',           type: 'select',   section: 'judgement', options: ['Low', 'Some concerns', 'High'], help: 'Cochrane RoB 2.0 overall judgement.' },
  { id: 'grade_certainty',         label: 'GRADE certainty of evidence',      type: 'select',   section: 'judgement', options: ['Very low', 'Low', 'Moderate', 'High'], help: 'Your independent GRADE assessment for the primary outcome.' },
];
